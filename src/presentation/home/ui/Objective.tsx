...
import maskedDoctor from "@/assets/images/masked-doctor.png";
...
const Objective = () => {
  return (
    <div className="bg-primary-100">
      <div className={`sm:mt-32 mt-24 py-15 sm:py-32 sm:grid grid-cols-2 ${LANDING_X_PADDING} ${APP_CONTAINER}`}>
        <div>
          <Image src={maskedDoctor} alt="" className=" w-full" />
        </div>
          ...
          <ul className="flex flex-col">
            {objectives.map((objective, ind) => (
              <li className="flex" key={ind}>
                ...
                <p className="mt-5 leading-6 text-dark tracking-wider">{objective}</p>
              </li>
            ))}
          </ul>
