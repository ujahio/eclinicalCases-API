...
const ResponsesAndFeedback = () => {
  const [showResponseAndFeedbackModal, setShowResponseAndFeedbackModal] = useState(false);
  ...
  return (
    <AdminLayout>
      ...
      >
        ...
        <div className=" bg-neutral-200  rounded-sm w-40 text-center py-2 text-xs">4 Responses & Feedbacks</div>
      </article>
        ...
        {data.map(({ img, name, id }) => (
          ...
          >
            <div className="flex">
              ...
              <div className="ml-3">
                <h2 className="text-lg text-dark font-medium">{name}</h2>
                <p className="text-grey-300">
                  <span className="font-medium">Submitted on:</span> 7 Aug 2020
                </p>
              </div>
            </div>
          </div>
