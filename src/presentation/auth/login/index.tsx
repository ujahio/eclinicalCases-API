                ...
                {(msg) => {
                  return (
                    <div className="flex justify-start items-center gap-2 mt-2 pl-[18px]">
                      <Image src={ExclamationMark} alt="Error Icon" className="h-6 w-6" />
                      <p className="text-[#F13030] font-montserrat font-normal text-sm">{msg}</p>
                    </div>
                  );
                }}
              </ErrorMessage>
            ...
            <div className="mt-8">
              ...
              <div className="mt-1.5">
                <CheckBox onChange={() => {}} isChecked={false} name="remember">
                  <span className="text-sm text-grey-300 font-medium inline-block ml-1.25">Keep me logged in</span>
                </CheckBox>
              </div>
