			...
			<div className="create-case-container">
									...
									<ul>
										{question.options.map(
											(option: any, optionIndex: number) => (
												<li
													className="flex items-stretch mt-2.5"
													key={optionIndex}
												>
													<label
				...
				<div className="mb-6 mt-6">
					<button
						...
						className={
							"sm:text-sm cursor-pointer rounded-md outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 transition-all duration-100 flex items-center uppercase relative font-medium w-full justify-between px-4 py-3 bg-grey-200 text-dark"
						}
					>
