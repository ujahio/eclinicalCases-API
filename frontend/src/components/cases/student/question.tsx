...
const StudentCaseQuestion: FunctionComponent<StudentCaseQuestionProps> = ({
  ...
  const [editorState, setEditorState] = useState(() =>
    caseDetails.caseExplanation
      ? EditorState.createWithContent(convertFromRaw(JSON.parse(caseDetails.caseExplanation)))
  ...
  return (
    <>
      <div className="mb-5 sm:mb-6">
        <h6 className="text-1xs sm:text-sm font-bold text-blue uppercase mb-2.5">Case Model QUESTION</h6>
        <InputField
        ...
        <div className="mt-5">
          <div className="text-grey-300 text-1sm capitalize font-normal">Give Further Explanation For Your Answer</div>
