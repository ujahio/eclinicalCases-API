...
const signup = async (req, res) => {
	...
	let originalPassword = decryptPassword(password, SECRETS.PassSecret);
...
const verifyOtpAndResetPassword = async (req, res) => {
	...
	try {
		let originalPassword = decryptPassword(newPassword, SECRETS.PassSecret);
...
const updatePassword = async (req, res) => {
	try {
		...
		let originalNewPassword = decryptPassword(newPassword, SECRETS.PassSecret);
